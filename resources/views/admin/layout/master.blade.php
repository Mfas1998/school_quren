                ...
                <div class="page-main-header">
                    ...
                    <div class="left-menu-header col">
                        ...
                        <li>
                            ...
                            </form><span class="d-sm-none mobile-search search-bg">
                    ...
                    <div class="nav-right col pull-right right-menu p-0">
                        ...
                        <li class="onhover-dropdown">
                            ...
                            <ul class="notification-dropdown onhover-show-div">
                                <li><p class="f-w-700 mb-0">You have 3 Notifications<span class="pull-right badge badge-primary badge-pill">4</span></p></li>
          ...
          <nav>
            <div class="main-navbar">
              ...
              <div id="mainnav">
                ...
                <li class="back-btn">
                    <div class="mobile-back text-end"><span>Back</span><i class="fa fa-angle-right ps-1" aria-hidden="true"></i></div>  --}}
                </li>

                    <li class="dropdow">
                        <a class="nav-link " href="#"><i data-feather="home"></i><span>Dashboard</span></a>
                    </li>
                    <li class="dropdow">
                        <a class="nav-link " href="{{ route('parent.index') }}"><i data-feather="edit-3"></i><span>Builders</span></a>
                    </li>
                    <li class="dropdow">
                        <a class="nav-link " href="{{ route('teacher.index') }}"><i data-feather="edit-3"></i><span>Teacher</span></a>
                    </li>
